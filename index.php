...
<body>
	...
	<section class="container py-16 space-y-16">
		...
		<section class="grid lg:grid-cols-7 gap-16">
			<main class="lg:col-span-5 space-y-16">
				<!-- informasi pejabat -->
				<section id="goverment" class="bg-base-gray rounded-xl shadow-lg relative">
					<div class="splide__track">
						<ul class="splide__list">
							<?php foreach (range(0, 5) as $i) { ?>
								<li class="splide__slide">
			...
			<aside class="lg:col-span-2">
				<div class="bg-base-gray rounded-xl p-4 space-y-6 shadow-lg">
	...
	<!-- events -->
	<section class="bg-base-gray py-16">
		<div class="container">
	...
	<section class="py-16 bg-base-gray">
		<div class="container">
